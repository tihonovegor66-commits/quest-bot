...
STEPS = [
    {
        ...
        "caption": "Верно! Быстрое начало! Держи подсказку, найди слово на стенде рядом с этим местом и не забудь сфотографировать)📸\n\n"
    ...
    },
    {
        ...
        "caption": "Круто! Последний рывок 🏁 используй карту ГАСУ\n\n"
